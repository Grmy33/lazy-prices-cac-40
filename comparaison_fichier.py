# -*- coding: utf-8 -*-
import os
#script pyhon permettant de comparer l'�volution du nb de mots pour une enterprise mais pour des ann�es diff�rentes � partir du fichier TXT liste_entreprise.txt
list_of_words=[]
